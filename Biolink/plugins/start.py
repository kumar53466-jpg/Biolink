...
If you need help or updates, check the buttons below 👇"""
        ...
        buttons = InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("➕ Add me to your group", url="https://t.me/Linkdeceterbot?startgroup=true")],
                [InlineKeyboardButton("📢 Updates Channel", url="https://t.me/cewefesbuk")],
                [InlineKeyboardButton("❓ Help & Commands", callback_data="help")]
            ]
        )

        photo_url = "https://files.catbox.moe/uva2vv.mp4"
